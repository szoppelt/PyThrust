"""OpenMDAO Propulsion Co-Design Optimization and Sweep.

This script demonstrates how to use OpenMDAO to optimize a drone propulsion system
(Motor Kv, Propeller Diameter, and Throttle) for maximum efficiency in hover, and
plots the design space sweep using the default Matplotlib appearance.
"""
...
def main():
    ...
    model.add_constraint('thrust_n', equals=4.903, ref=5.0)  # 500 gf thrust target
    model.add_constraint('motor_current_a', upper=25.0, ref=25.0)
    model.add_objective('battery_power_w', ref=100.0)

    # Setup Scipy SLSQP Driver
    prob.driver = om.ScipyOptimizeDriver(optimizer='SLSQP')
    prob.driver.options['disp'] = False  # quiet run
    prob.setup()

    # Set initial baseline conditions
    ...
    # 3. Perform Parametric Sweep of Kv
    ...
    # Setup a sub-problem for the sweeps
    ...
    # 4. Plot using Default Matplotlib Appearance
